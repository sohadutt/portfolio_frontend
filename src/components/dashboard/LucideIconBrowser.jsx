        ...
        <ScrollArea className="h-[680px] px-6 py-6">
          <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
            {filteredIcons.map(([key, tags]) => {
              return (
                <div key={key} className="flex items-center gap-3 rounded-xl border border-border/60 bg-background/70 p-4">
                  ...
                  <Button type="button" variant="ghost" size="icon-sm" onClick={() => handleCopy(key)}>
